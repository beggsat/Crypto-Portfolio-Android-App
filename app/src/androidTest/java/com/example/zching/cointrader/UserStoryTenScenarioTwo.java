...
Scenario 2:
    ...
    When I click on comparing Bitcoin and litecoin
    Then both coin's stats should be available

 */
@LargeTest
@RunWith(AndroidJUnit4.class)
public class UserStoryTenScenarioTwo {
    ...
    public void test() {
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.compare2), withText("Bitcoin and Litecoin"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView11), withText("Litecoin"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Litecoin")));
