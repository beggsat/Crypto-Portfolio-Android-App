...
public class UserStoryTwelveScenarioThree {
    ...
    public void userStoryTwelveScenarioThree() {
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.compositionButton), withText("Comp"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
