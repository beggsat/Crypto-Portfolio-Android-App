...
public class SubtractScreen extends AppCompatActivity implements Serializable , AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtract_screen);
        setTitle("Sell one of your coins");
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SubtractScreen.this, android.R.layout.simple_spinner_item, paths);
    ...
    public void pSubmitClicked(View view) {
        ...
        if ((tempCoin.getAmountOwned() - amount) <= 0) {
            Toast.makeText(SubtractScreen.this, "Cant sell more than you own",
